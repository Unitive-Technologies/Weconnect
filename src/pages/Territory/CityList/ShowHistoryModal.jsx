...
const ShowHistoryModal = ({ isOpen, toggleHistoryModal, city }) => {
  console.log("Show History Modal in ReasonList" + city)
  ...
  const getHistoryDetails = async (e) => {
    try {
      ...
      const response = await axios.get(
        `${API_URL}/administrative-division/${city.id
  ...
  return (
    ...
    >
      <ModalHeader toggle={toggleHistoryModal} tag="h4" position="relative">
        <h4>Regional Office History ({city.name})</h4>
      </ModalHeader>
      <ModalBody>
        <div
          style={{
