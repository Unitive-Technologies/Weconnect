...
const ShowHistoryModal = ({ isOpen, toggleHistoryModal, location }) => {
  console.log("Show History Modal in ReasonList" + location)
  ...
  return (
    ...
    >
      <ModalHeader toggle={toggleHistoryModal} tag="h4" position="relative">
        <h4>Regional Office History ({location.name})</h4>
      </ModalHeader>
      <ModalBody>
        <div
          style={{
