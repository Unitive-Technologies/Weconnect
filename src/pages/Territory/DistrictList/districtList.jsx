...
import { Email, Tags, Projects } from "./districtListCol";
...
const DistrictList = (props) => {
  ...
  useEffect(() => {
    console.log("Customer Users data in component:", districts);
  }, [districts]);
  ...
  return (
    <React.Fragment>
      ...
      />
      <AddNewDistrict isOpen={showAddDistrict} toggle={toggle} />
