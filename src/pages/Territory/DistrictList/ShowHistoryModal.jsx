...
const ShowHistoryModal = ({ isOpen, toggleHistoryModal, district }) => {
  console.log("Show History Modal in ReasonList" + district)
  ...
  const getHistoryDetails = async (e) => {
    try {
      ...
      const response = await axios.get(
        `${API_URL}/administrative-division/${district.id
  ...
  return (
    ...
    >
      <ModalHeader toggle={toggleHistoryModal} tag="h4" position="relative">
        <h4>Regional Office History ({district.name})</h4>
      </ModalHeader>
      <ModalBody>
        <div
          style={{
