...
import { Modal, ModalBody, Table, ModalHeader, Row, Col, Input } from "reactstrap";
import TableContainer from "../../../components/Common/TableContainer";

const ShowHistoryModal = ({ isOpen, toggleHistoryModal, sublocation }) => {
  console.log("Show History Modal in ReasonList" + sublocation)
  ...
  const getHistoryDetails = async (e) => {
    try {
      ...
      const response = await axios.get(
        `${API_URL}/sublocation/${sublocation.id
  ...
  return (
    ...
    >
      <ModalHeader toggle={toggleHistoryModal} tag="h4" position="relative">
        <h4>Sublocation History ({sublocation.name})</h4>
      </ModalHeader>
      <ModalBody>
        <div
          style={{
