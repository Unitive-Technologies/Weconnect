...
const ViewSubCategoryList = (props) => {
    ...
    const validation = useFormik({
        ...
        initialValues: {
            ...
            category_lbl: (complaintsubcategory && complaintsubcategory.category_lbl) || "",
            showonweb_lbl: (complaintsubcategory && complaintsubcategory.showonweb_lbl) || "",
            status_lbl: (complaintsubcategory && complaintsubcategory.status_lbl) || "",
            description: (complaintsubcategory && complaintsubcategory.description) || "",
        },
            ...
            >
                {!showEditUser ? (
                    <ModalHeader toggle={toggle} tag="h4">
                        View {complaintsubcategory.name}
                        <i
                    ...
                    <ModalHeader toggle={toggle} tag="h4">
                        Edit {complaintsubcategory.name}
                    </ModalHeader>
                )}
                <ModalBody>
                    <Form
