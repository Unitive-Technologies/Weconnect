...
const ShowHistoryModal = ({ isOpen, toggleHistoryModal, complaintsubcategory }) => {
  // console.log("Show History Modal in ReasonList" + complaintsubcategory)
  ...
  const getHistoryDetails = async (e) => {
    try {
      ...
      const response = await axios.get(
        `${API_URL}/complaint-subcategory/${complaintsubcategory.id
  ...
  return (
    ...
    >
      <ModalHeader toggle={toggleHistoryModal} tag="h4" position="relative">
        <h4>ComplaintSubcategory History ({complaintsubcategory.name})</h4>
      </ModalHeader>
      <ModalBody>
        <div
          style={{
