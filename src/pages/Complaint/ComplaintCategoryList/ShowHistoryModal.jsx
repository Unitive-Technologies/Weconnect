...
const ShowHistoryModal = ({ isOpen, toggleHistoryModal, complaintcategory }) => {
  console.log("Show History Modal in ReasonList" + complaintcategory)
  ...
  const getHistoryDetails = async (e) => {
    try {
      ...
      const response = await axios.get(
        `${API_URL}/complaint-category/${complaintcategory.id
  ...
  return (
    ...
    >
      <ModalHeader toggle={toggleHistoryModal} tag="h4" position="relative">
        <h4>ComplaintCategory History ({complaintcategory.name})</h4>
      </ModalHeader>
      <ModalBody>
        <div
          style={{
