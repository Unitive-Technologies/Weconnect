      ...
      try {
        ...
        addOperatorsData.forEach((operator) => {
          ...
          if (operator.expiryDate && operator.id) {
            if (!newRemoveAssign.operator_expiry[operator.expiryDate]) {
              newRemoveAssign.operator_expiry[operator.expiryDate] = [
                operator.id,
              ];
            } else {
              newRemoveAssign.operator_expiry[operator.expiryDate].push(
                operator.id
              );
            }
          }
        ...
        console.log("newAssign:", JSON.stringify(newRemoveAssign));
