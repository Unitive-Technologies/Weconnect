...
const ShowHistoryModal = ({ isOpen, toggleHistoryModal, brand }) => {
  console.log("Show History Modal in ReasonList" + brand)
  ...
  return (
    ...
    >
      <ModalHeader toggle={toggleHistoryModal} tag="h4" position="relative">
        <h4>Brand History ({brand.name})</h4>
      </ModalHeader>
      <ModalBody>
        <div
          style={{
