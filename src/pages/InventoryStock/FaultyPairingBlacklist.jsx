...
import {
  updateFaultyPairingBlacklist as onUpdateFaultyPairingBlacklist,
  getInventoryFaultyPairing as onGetInventoryFaultyPairing,
} from "/src/store/inventoryfaulty/actions";

function FaultyPairingBlacklist(props) {
  ...
  const validation = useFormik({
    ...
    onSubmit: (values) => {
      ...
      dispatch(onUpdateFaultyPairingBlacklist(newBlacklist));
...
FaultyPairingBlacklist.propTypes = {
  toggle: PropTypes.func,
  isOpen: PropTypes.bool,
  selectedFaultyPairings: PropTypes.array,
};

export default FaultyPairingBlacklist;
