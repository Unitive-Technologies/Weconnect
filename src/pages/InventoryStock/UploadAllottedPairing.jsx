...
import {
  ...
  uploadPairingAllotmentSubmit,
} from "../../helpers/backend_helper";
import { getResponse } from "../../helpers/api_helper";

const UploadAllottedPairing = (props) => {
  ...
  function handleAcceptedFiles(files) {
    ...
    updatePairingAllotmentUploadByToken(
      uploadTrigger.token,
      uploadAllottedPairingSavedTemplatePayload
    )
      .then((res) => {
        console.log(
  ...
  const uploadAllottedPairingDownloadTemplatePayload = {
    meta_data: {
  ...
  const uploadAllottedPairingSavedTemplatePayload = {
    meta_data: {
      type: parseInt(usertype),
      operator_id: id,
    },
  ...
  const handleDownloadSampleFile = () => {
    ...
    downloadPairingAllotmentUploadTemplate(
      uploadAllottedPairingDownloadTemplatePayload
    )
      .then((res) => {
        // debugger;
  ...
  const handleUploadFile = () => {
    ...
    uploadPairingAllotmentSubmit(uploadTrigger.token, formData)
      .then((res) => {
        toggleSuccessMsg();
        console.log(
...
UploadAllottedPairing.propTypes = {
...
export default UploadAllottedPairing;
