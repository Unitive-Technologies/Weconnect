...
function DeleteStockPairing(props) {
  ...
  const validation = useFormik({
    ...
    onSubmit: (values) => {
      const deletedDetails = {
        pairing_id: selectedPairings.map((row) => row.id),
      };
      console.log("Deleted details: " + JSON.stringify(deletedDetails));
      dispatch(onDeleteStockPairing(deletedDetails));
  ...
  return (
    <Modal
      ...
      toggle={toggle}
    >
      <ModalHeader toggle={toggle}>Delete Pairing</ModalHeader>
      <Form
        onSubmit={(e) => {
          e.preventDefault();
...
DeleteStockPairing.propTypes = {
  toggle: PropTypes.func,
  isOpen: PropTypes.bool,
  selectedPairings: PropTypes.array,
};

export default DeleteStockPairing;
