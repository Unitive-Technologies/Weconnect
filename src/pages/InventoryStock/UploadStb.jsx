...
const UploadStb = (props) => {
  ...
  function handleAcceptedFiles(files) {
    ...
    updateStbUploadByToken(
      ...
      .then((res) => {
        console.log("res in updateStbUploadByToken: " + JSON.stringify(res));
      })
      .catch((error) => {
        console.log("error in updateStbUploadByToken: " + error);
      });
  }
  ...
  const handleDownloadSampleFile = () => {
    ...
    downloadStbUploadTemplate(stbBulkUpdateDownloadTemplatePayload)
      .then((res) => {
        // debugger;
  ...
  const handleUploadFile = () => {
    ...
    uploadStbSubmit(uploadTrigger.token, formData)
      .then((res) => {
        toggleSuccessMsg();
        console.log(
