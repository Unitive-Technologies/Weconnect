...
const ShowHistoryModal = ({ isOpen, toggleHistoryModal, viewBroadcaster }) => {
  console.log("Show History Modal in ReasonList" + viewBroadcaster)
  ...
  const getHistoryDetails = async (e) => {
    try {
      ...
      const response = await axios.get(
        `${API_URL}/broadcaster/${viewBroadcaster.id
  ...
  return (
    ...
    >
      <ModalHeader toggle={toggleHistoryModal} tag="h4" position="relative">
        <h4>Broadcaster History ({viewBroadcaster.msg_head})</h4>
      </ModalHeader>
      <ModalBody>
        <div
          style={{
