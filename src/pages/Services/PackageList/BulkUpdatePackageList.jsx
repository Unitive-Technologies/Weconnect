...
import {
  downloadBulkUpdatePackageUploadTemplate,
  updateBulkUpdatePackageUploadByToken,
  uploadBulkUpdatePackageSubmit,
} from "../../../helpers/backend_helper";

const BulkUpdatePackageList = (props) => {
  ...
  function handleAcceptedFiles(files) {
    ...
    updateBulkUpdatePackageUploadByToken(uploadTrigger.token, packageSavedTemplatePayload)
      .then((res) => {
        console.log("res in updatePackageUploadByToken:" + JSON.stringify(res));
      })
      .catch((error) => {
        console.log("error in updatePakcageUploadByToken:" + error);
      });
  }
  ...
  const handleDownloadSampleFile = () => {
    ...
    downloadBulkUpdatePackageUploadTemplate(packageDownloadTemplatePayload)
      .then((res) => {
        debugger;
  ...
  const handleUploadFile = () => {
    ...
    uploadBulkUpdatePackageSubmit(uploadTrigger.token, formData)
      .then((res) => {
        // debugger;
        toggleSuccessMsg();
        console.log(
...
BulkUpdatePackageList.propTypes = {
  toggle: PropTypes.func,
  isOpen: PropTypes.bool,
};

export default BulkUpdatePackageList;
