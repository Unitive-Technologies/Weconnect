...
import {
  downloadPackageUploadTemplate,
  updatePackageUploadByToken,
  uploadPackageSubmit,
} from "../../../helpers/backend_helper";

const UploadPackageList = (props) => {
  const { isOpen, toggleUploadModal, packageStatus, actiontype } = props;
  ...
  function handleAcceptedFiles(files) {
    ...
    updatePackageUploadByToken(uploadTrigger.token, packageSavedTemplatePayload)
      .then((res) => {
  ...
  const handleDownloadSampleFile = () => {
    ...
    downloadPackageUploadTemplate(packageDownloadTemplatePayload)
      .then((res) => {
        // debugger;
  ...
  const handleUploadFile = () => {
    ...
    uploadPackageSubmit(uploadTrigger.token, formData)
      .then((res) => {
        // debugger;
        toggleSuccessMsg();
        console.log(
    ...
    <>
      ...
      >
        <Toast isOpen={successMsg}>
          ...
          <ToastBody>Upload Package Successfully</ToastBody>
        </Toast>
      </div>
      <Modal
        isOpen={isOpen}
