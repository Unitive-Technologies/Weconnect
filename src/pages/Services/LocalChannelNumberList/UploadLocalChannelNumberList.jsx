...
// const UploadLocalChannelNumberList = (props) => {
...
// UploadLocalChannelNumberList.propTypes = {
//     toggle: PropTypes.func,
//     isOpen: PropTypes.bool,
// };

// export default UploadLocalChannelNumberList;
...
import {
    downloadLCNUploadTemplate,
    updateLCNUploadByToken,
    uploadLCNSubmit,
...
const UploadLocalChannelNumberList = (props) => {
    ...
    function handleAcceptedFiles(files) {
        ...
        updateLCNUploadByToken(uploadTrigger.token, LCNSavedTemplatePayload)
            .then((res) => {
                console.log("res in updateLCNUploadByToken:" + JSON.stringify(res));
            })
            .catch((error) => {
                console.log("error in updateLCNUploadByToken:" + error);
            });
    }

    const LCNSavedTemplatePayload = {
        meta_data: { type: "" },
        url: "",
    };

    const LCNDownloadTemplatePayload = {
        meta_data: { type: "" },
        url: "",
    };
    ...
    const handleDownloadSampleFile = () => {
        ...
        downloadLCNUploadTemplate(LCNDownloadTemplatePayload)
            .then((res) => {
                debugger;
            ...
            .catch((error) => {
                console.log("error in downloadLCNUploadTemplate:" + error);
            });
    };
    ...
    const handleUploadFile = () => {
        ...
        uploadLCNSubmit(uploadTrigger.token, formData)
            .then((res) => {
                // debugger;
                toggleSuccessMsg();
                console.log(
        ...
        <>
            ...
            >
                <Toast isOpen={successMsg}>
                    ...
                    <ToastBody>Upload LCN Successfully</ToastBody>
                </Toast>
            </div>
            <Modal
                isOpen={isOpen}
