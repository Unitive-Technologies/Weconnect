...
const ShowHistoryModal = ({ isOpen, toggleHistoryModal, osdConfiguration }) => {
  console.log("Show History Modal in ReasonList" + osdConfiguration)
  ...
  const getHistoryDetails = async (e) => {
    try {
      ...
      const response = await axios.get(
        `${API_URL}/mtc/${osdConfiguration.id
  ...
  return (
    ...
    >
      <ModalHeader toggle={toggleHistoryModal} tag="h4" position="relative">
        <h4>OSD Configuration History ({osdConfiguration.name})</h4>
      </ModalHeader>
      <ModalBody>
        <div
          style={{
