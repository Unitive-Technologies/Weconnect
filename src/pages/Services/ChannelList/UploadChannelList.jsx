...
import {
  downloadChannelUploadTemplate,
  updateChannelUploadByToken,
  uploadChannelSubmit,
} from "../../../helpers/backend_helper";

const UploadChannelList = (props) => {
  const { isOpen, toggleUploadModal, channelListStatus, actiontype } = props;
  ...
  function handleAcceptedFiles(files) {
    ...
    updateChannelUploadByToken(uploadTrigger.token, channelSavedTemplatePayload)
      .then((res) => {
  ...
  const handleDownloadSampleFile = () => {
    ...
    downloadChannelUploadTemplate(channelDownloadTemplatePayload)
      .then((res) => {
        debugger;
  ...
  const handleUploadFile = () => {
    ...
    uploadChannelSubmit(uploadTrigger.token, formData)
      .then((res) => {
        // debugger;
        toggleSuccessMsg();
        console.log(
    ...
    <>
      ...
      >
        <Toast isOpen={successMsg}>
          ...
          <ToastBody>Upload Channel Successfully</ToastBody>
        </Toast>
      </div>
      <Modal
        isOpen={isOpen}
...
UploadChannelList.propTypes = {
  toggle: PropTypes.func,
  isOpen: PropTypes.bool,
};

export default UploadChannelList;
