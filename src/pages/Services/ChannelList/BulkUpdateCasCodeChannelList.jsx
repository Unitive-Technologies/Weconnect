...
const BulkUpdateCasCodeChannelList = (props) => {
  const { isOpen, handleUpdateCasCode, channelListCascode, actiontype } = props;

  const dispatch = useDispatch();
  const [uploadTrigger, setUploadTrigger] = useState({});
  const [selectedFiles, setSelectedFiles] = useState([]);
  const [channelCascode, setChannelListCascode] = useState("");
...
BulkUpdateCasCodeChannelList.propTypes = {
  toggle: PropTypes.func,
  isOpen: PropTypes.bool,
};

export default BulkUpdateCasCodeChannelList;
