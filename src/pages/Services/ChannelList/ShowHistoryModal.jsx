...
const ShowHistoryModal = ({ isOpen, toggleHistoryModal, channel }) => {
  console.log("Show History Modal in ReasonList" + channel)
  ...
  return (
    ...
    >
      <ModalHeader toggle={toggleHistoryModal} tag="h4" position="relative">
        <h4>Channel History ({channel.name})</h4>
      </ModalHeader>
      <ModalBody>
        <div
          style={{
