...
import {
    downloadLanguageUploadTemplate,
    updateLanguageUploadByToken,
    uploadLanguageSubmit,
} from "../../../helpers/backend_helper";

const UploadLanguageList = (props) => {
    const { isOpen, toggleUploadLanguage, langlistStatus, actiontype } = props;
    ...
    function handleAcceptedFiles(files) {
        ...
        updateLanguageUploadByToken(uploadTrigger.token, languageSavedTemplatePayload)
            .then((res) => {
                console.log("res in updateLanguageUploadByToken:" + JSON.stringify(res));
            })
            .catch((error) => {
                console.log("error in updateLanguageUploadByToken:" + error);
            });
    }

    const languageSavedTemplatePayload = {
    ...
    const handleDownloadSampleFile = () => {
        ...
        downloadLanguageUploadTemplate(languageDownloadTemplatePayload)
            .then((res) => {
                // debugger;
    ...
    const handleUploadFile = () => {
        ...
        uploadLanguageSubmit(uploadTrigger.token, formData)
            .then((res) => {
                // debugger;
                toggleSuccessMsg();
                console.log(
                    "res in uploadLanguageFileForInitiatedUserUpload:" + JSON.stringify(res)
                );
                ...
                dispatch(onAddNewLanguageList(res.data.data));
                toggleUploadLanguage();
            })
            .catch((error) => {
        ...
        <>
            ...
            >
                <Toast isOpen={successMsg}>
                    ...
                    <ToastBody>Upload Language Successfully</ToastBody>
                </Toast>
            </div>
            <Modal
                isOpen={isOpen}
                ...
                tabIndex="-1"
                toggle={toggleUploadLanguage}
            >
                {/* <Modal isOpen={modal} toggle={toggle}> */}
                <ModalHeader toggle={toggleUploadLanguage} tag="h4">
                    Upload Language
                </ModalHeader>
                <ModalBody>
                    <Card>
